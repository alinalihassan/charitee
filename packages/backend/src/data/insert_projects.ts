...
import { ICountryDocument, IThemeDocument, IOrganizationDocument } from '../models/Documents';
...
const insertProjects = async () => {
    ...
    for (var p = 0; p < projects.length; p++) {
        ...
        try {
            ...
            // Set Country
            var default_country: ICountryDocument;
            ...
            // Set Organization
            var organization: IOrganizationDocument;
            ...
            new Project(proj_fields).save(function(err: Error) {});
