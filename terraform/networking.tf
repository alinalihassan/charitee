resource "google_compute_region_network_endpoint_group" "charitee-neg" {
...
resource "google_compute_backend_service" "charitee-backend-service" {
  project    = google_project.web-project.project_id
  ...
  backend {
    group = google_compute_region_network_endpoint_group.charitee-neg.id
  }
}
...
resource "google_compute_url_map" "default" {
  ...
  default_service = google_compute_backend_service.charitee-backend-service.id
}
