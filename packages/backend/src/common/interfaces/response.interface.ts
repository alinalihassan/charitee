...
export type JSendObject<T extends object | null> =
  ...
  | JSendFailureObject
  | JSendFailureObjectwithData<Required<T>>
  | JSendErrorObject
 ...
 */
export interface JSendSuccessObject<T extends object | null> extends JSendBaseObject {
  status: "success";
  message?: string;
  data?: T;
}
 ...
 */
 ...
 export interface JSendFailureObject extends JSendBaseObject {
  status: "fail";
  message: string;
  code?: number;
}

export interface JSendFailureObjectwithData<T extends object>
